...
"""
 Description:
           Once chosen the scaling factor ratio, all indices
           parameters and once read the image on which test the algorithms,
           all models are tested. 
           If results == True, all the results are printed as .csv files and 
           the images are saved in the directory ./results as .mat files.
"""
